...
- [start-streaming](https://github.com/enalmada/start-streaming) Real-time streaming infrastructure with auto-reconnection
...
5. Check out the **real-time streaming demo** at [http://localhost:3000/debug/streaming](http://localhost:3000/debug/streaming) to see `@enalmada/start-streaming` in action.
