...
// Note: Destructuring style/disabled to handle exactOptionalPropertyTypes compatibility with Base UI
// When render prop is provided, automatically set nativeButton=false to avoid Base UI warnings
function Button({
	className,
	variant = "default",
	size = "default",
